...
__all__ = [
    'SpeechFormatType', 'eLEXTYPE_PRIVATE7',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRGState',
    'eLEXTYPE_RESERVED4', 'ISpPhrase', 'DISPID_SOTGetStorageFileName',
    'SpeechEngineProperties', 'SpeechMicTraining', 'SITooFast',
    'DISPIDSPTSI', 'DISPID_SpeechRecoResult',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SAEventHandle', 'DISPID_SAFSetWaveFormatEx',
    'eLEXTYPE_PRIVATE16', 'eWORDTYPE_DELETED',
    'DISPID_SPERetainedSizeBytes', 'SPEI_RECO_STATE_CHANGE',
    'SGLexicalNoSpecialChars', 'SVEWordBoundary', 'SPPHRASEELEMENT',
    'DISPID_SDKGetStringValue', 'SDA_No_Trailing_Space',
    'DISPID_SOTs_NewEnum', 'SP_VISEME_6', 'SDTLexicalForm',
    'SpCompressedLexicon', 'Speech_Max_Pron_Length', 'SRSEDone',
    'SPVPRI_NORMAL', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpRecoContext2', 'SPFM_NUM_MODES',
    'DISPIDSPRG', 'DISPID_SRRSpeakAudio',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRRTimes',
    'SPINTERFERENCE_TOOQUIET', 'SAFTCCITT_ALaw_22kHzMono',
    'SPWT_DISPLAY', 'ISpRecognizer3', 'DISPID_SRCBookmark',
    'SPFM_CREATE_ALWAYS', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVIsUISupported', 'SpeechAudioVolume',
    'ISpObjectWithToken', 'DISPID_SAFGuid', 'SAFTGSM610_11kHzMono',
    'SPVPRI_OVER', 'SpSharedRecognizer', 'SPBINARYGRAMMAR',
    'DISPID_SRSSupportedLanguages', 'SAFTADPCM_11kHzStereo',
    'ISpeechRecognizerStatus', 'SVEPrivate', 'SPWT_LEXICAL',
    'DISPID_SpeechAudioStatus', 'DISPID_SGRAttributes',
    'DISPID_SPEDisplayAttributes', 'SGLexical', 'SPSERIALIZEDRESULT',
    'SPEI_SOUND_START', 'SRTAutopause', 'SSFMCreateForWrite',
    ...
    'SPINTERFERENCE_TOOFAST', 'SPSMF_SAPI_PROPERTIES', 'SVP_5',
    'ISpeechPhoneConverter', 'DISPID_SVEViseme',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRCRequestedUIType',
    'DISPID_SRRRecoContext', 'DISPID_SPERetainedStreamOffset',
    'SPEI_REQUEST_UI', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechGrammarRule', 'SAFT12kHz8BitStereo',
    'DISPID_SVEEnginePrivate', 'ISpPhraseAlt', 'eLEXTYPE_PRIVATE8',
    'DISPID_SMSALineId', 'DISPID_SRCRecognizer', 'SPWF_SRENGINE',
    'SPCS_DISABLED', 'SREPropertyNumChange',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SGRName', 'SVP_11',
    'SRTReSent', 'SECLowConfidence', 'SP_VISEME_10',
    'DISPID_SLPLangId', 'DISPID_SGRSTPropertyName', 'SVP_13',
    'SRTExtendableParse', 'DISPID_SFSClose', 'SPPHRASEREPLACEMENT',
    'SAFT48kHz8BitStereo', 'SRTStandard', 'eLEXTYPE_LETTERTOSOUND',
    'SVESentenceBoundary', 'ISpeechPhraseAlternate',
    'eLEXTYPE_PRIVATE19', 'SpeechRecognitionType',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRCCmdMaxAlternates',
    'SpeechInterference', 'SAFT8kHz8BitMono', 'SPWF_INPUT', 'SVP_14',
    'DISPID_SGRsCount', 'DISPID_SMSSetData', 'DISPID_SDKDeleteValue',
    'Speech_StreamPos_RealTime', 'DISPID_SRIsShared', 'SPRS_INACTIVE',
    'ISpNotifySource', 'DISPID_SLGetGenerationChange',
    'DISPID_SFSOpen', 'eLEXTYPE_RESERVED7', 'SDKLCurrentConfig',
    'ISpVoice', 'SpTextSelectionInformation',
    'DISPID_SOTCEnumerateTokens', 'SFTSREngine', 'ISpAudio',
    'SPGRAMMARSTATE', 'SAFT11kHz8BitMono', 'SRAExport',
    'SECNormalConfidence', 'SpMemoryStream', 'DISPID_SpeechLexicon',
    '_ISpeechVoiceEvents', 'SAFT11kHz8BitStereo',
    'DISPID_SpeechObjectTokens', 'DISPID_SOTsCount', 'SPSModifier',
    'SAFTADPCM_22kHzStereo', 'DISPID_SBSSeek', 'SPSFunction',
    'SPEI_END_INPUT_STREAM', 'DISPID_SPIGetText',
    'DISPID_SOTCategory', 'STCInprocHandler', 'DISPID_SRCVoice',
    'SPEI_SR_RETAINEDAUDIO', 'SpeechAudioFormatType', 'SITooQuiet',
    'SpeechWordPronounceable', 'ISpeechXMLRecoResult',
    'DISPID_SRRDiscardResultInfo', 'SREInterference', 'SVP_1',
    'DISPID_SPACommit', 'DISPID_SGRSTWeight', 'ISpRecognizer',
    'DISPID_SGRSTText', 'DISPID_SRGId', 'IEnumSpObjectTokens',
    'SPPS_SuppressWord', 'SPFM_OPEN_READWRITE', 'SPEI_TTS_BOOKMARK',
    'ISpeechPhraseElements', 'eLEXTYPE_PRIVATE5',
    'DISPID_SpeechPhraseElements', 'SGDSActiveUserDelimited',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SWFEFormatTag',
    'SPRS_ACTIVE_USER_DELIMITED', 'SGRSTTTextBuffer',
    'DISPID_SpeechAudio', 'DISPID_SpeechPhraseInfo',
    'SAFT22kHz16BitStereo', 'DISPID_SVSLastBookmarkId',
    'SAFTCCITT_uLaw_22kHzMono', 'SPDKL_LocalMachine',
    'ISpeechResourceLoader', 'SpWaveFormatEx',
    'DISPID_SLGetPronunciations', 'SVSFParseAutodetect',
    'DISPID_SRRGetXMLResult', 'SPPS_Verb', 'SP_VISEME_4',
    'SP_VISEME_15', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SPPEngineConfidence', 'DISPID_SRCVoicePurgeEvent',
    'SVP_17', 'DISPID_SVEStreamStart', 'eLEXTYPE_PRIVATE6',
    'SP_VISEME_1', 'ISpStream', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'ISpeechRecoResultDispatch', 'ISpRecoCategory',
    'ISpeechRecoResult', 'SAFT24kHz8BitStereo', 'SPAS_PAUSE',
    'DISPID_SPIProperties', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPRs_NewEnum', 'SPAS_RUN',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechGrammarTagWildcard', 'DISPID_SRRPhraseInfo',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRRGetXMLErrorInfo',
    'SPLO_DYNAMIC', 'ISpeechFileStream', 'SPRST_ACTIVE',
    'SPEI_HYPOTHESIS', 'SPPS_Modifier', 'SPEI_START_SR_STREAM',
    'SDTAll', 'DISPID_SRCEInterference', 'ISpRecoResult',
    'SREAudioLevel', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPIGetDisplayAttributes', 'SREAllEvents',
    'DISPID_SASNonBlockingIO', 'DISPID_SGRsCommitAndSave',
    'SRAInterpreter', 'SRCS_Enabled', 'DISPID_SGRsFindRule',
    'SAFTDefault', 'SECFNoSpecialChars',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SABIEventBias',
    'SPPS_RESERVED3', 'DISPID_SDKOpenKey', 'DISPID_SPPChildren',
    'DISPID_SRCERequestUI', 'DISPID_SVAudioOutputStream', 'SPSMF_UPS',
    'DISPID_SRCERecognizerStateChange', 'SRTEmulated',
    'SPWORDPRONUNCIATION', 'DISPID_SRGCmdLoadFromMemory',
    'SDKLLocalMachine', 'DISPID_SADefaultFormat',
    'DISPID_SRGCmdLoadFromObject', 'SpeechRetainedAudioOptions',
    'DISPID_SPRulesItem', 'SPSInterjection',
    'DISPID_SVGetAudioInputs', 'SLTUser',
    'DISPID_SpeechGrammarRuleStateTransition', 'eLEXTYPE_MORPHOLOGY',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPBO_AHEAD', 'SpeechDiscardType',
    'DISPID_SRGetPropertyNumber', 'SAFTADPCM_8kHzStereo',
    'DISPID_SDKCreateKey', 'SINone', 'SVPAlert', 'SAFT8kHz16BitMono',
    'SSFMOpenForRead', 'DISPID_SDKGetlongValue', 'SPSHORTCUTPAIR',
    'ISpeechBaseStream', 'SPBOOKMARKOPTIONS',
    'DISPID_SLWPronunciations', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SLWsCount', 'SPEI_RESERVED3', 'SPPS_RESERVED1',
    'DISPID_SRAudioInputStream', 'DISPID_SVEVoiceChange',
    'SREPhraseStart', 'DISPID_SVWaitUntilDone', 'SPAO_NONE',
    'SAFT12kHz16BitMono', 'DISPID_SWFEAvgBytesPerSec', 'SVF_None',
    'DISPID_SVEPhoneme', 'DISPID_SWFEBlockAlign',
    'SAFTADPCM_44kHzMono', 'DISPID_SPEsItem',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpShortcut', 'SVP_6',
    'DISPID_SVDisplayUI', 'SVP_21', 'SpNullPhoneConverter', 'SBONone',
    'SRTSMLTimeout', 'SPAR_Medium', 'DISPID_SDKEnumValues',
    'ISpRecoGrammar2', 'eLEXTYPE_PRIVATE10', 'DISPID_SOTId',
    'SAFTText', 'DISPID_SVResume', 'SAFTADPCM_44kHzStereo',
    'STSF_FlagCreate', 'DISPID_SRSClsidEngine', 'DISPID_SABufferInfo',
    'DISPID_SRStatus', 'SPPS_Noncontent', 'DISPID_SRRAudio',
    'DISPID_SRCEBookmark', 'DISPID_SRSAudioStatus',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPPsCount',
    'DISPID_SRCRetainedAudio', 'SVEEndInputStream',
    'DISPID_SRCResume', 'SpeechRecoContextState',
    'DISPID_SRRSetTextFeedback', 'SPAUDIOOPTIONS',
    'DISPID_SGRSAddWordTransition', 'SPEI_MIN_SR',
    'SDA_Two_Trailing_Spaces', 'SAFT8kHz8BitStereo',
    'SpSharedRecoContext', 'SAFT22kHz8BitStereo', 'SPAS_CLOSED',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPPARTOFSPEECH', 'SVSFNLPMask',
    'SDA_Consume_Leading_Spaces', 'DISPID_SDKSetBinaryValue',
    'DISPID_SPPName', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SVEBookmark', 'SAFT44kHz8BitStereo', 'ISpeechAudio',
    'DISPID_SLAddPronunciation', 'SpeechCategoryVoices',
    'SPPS_RESERVED2', 'SITooLoud', 'SECFIgnoreWidth',
    'DISPID_SPRFirstElement', 'DISPID_SpeechFileStream',
    'SpeechAddRemoveWord', 'SPWORDPRONUNCIATIONLIST',
    'SPAO_RETAIN_AUDIO', 'eLEXTYPE_PRIVATE17', 'SPEI_RECOGNITION',
    'DISPID_SDKEnumKeys', 'DISPID_SVSpeakCompleteEvent',
    'SDKLDefaultLocation', 'ISpNotifySink', 'SPCT_SUB_COMMAND',
    'SPINTERFERENCE_TOOSLOW', 'ISpeechLexiconPronunciation',
    'SGRSTTWildcard', 'SPXMLRESULTOPTIONS',
    'DISPID_SPRuleEngineConfidence',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SRCEPhraseStart',
    'WAVEFORMATEX', 'eWORDTYPE_ADDED', 'DISPID_SVVoice',
    'DISPID_SpeechPhraseAlternate', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRCEAdaptation', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRGDictationSetState', 'SPWORDPRONOUNCEABLE',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SGRsCommit', 'SGRSTTEpsilon',
    'SECFIgnoreKanaType', 'SAFT44kHz8BitMono',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVPNormal',
    'DISPID_SpeechPhraseProperty', 'SITooSlow', 'ISpEventSource',
    'DISPID_SpeechXMLRecoResult', 'SGDSActiveWithAutoPause',
    'ISpRecoGrammar', 'SRATopLevel', 'SASRun', 'DISPID_SOTCSetId',
    'SAFTCCITT_ALaw_8kHzMono', 'SRCS_Disabled',
    'SpObjectTokenCategory', 'SPPS_Unknown',
    'DISPID_SpeechRecoContextEvents', 'SPSNotOverriden', 'SASPause',
    'SpeechVoiceEvents', 'SVF_Emphasis', 'SGRSTTDictation',
    'DISPID_SRCESoundEnd', 'SpeechVisemeFeature',
    'DISPID_SLPSymbolic', 'DISPID_SGRSTsCount', 'ISpXMLRecoResult',
    ...
    'SP_VISEME_12', 'SPFILEMODE', 'SPEI_UNDEFINED',
    'ISpeechWaveFormatEx', 'DISPID_SPIStartTime',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SRSInactive',
    'DISPID_SRRAlternates', 'SDTAlternates', 'SpeechRuleAttributes',
    'ISpStreamFormatConverter', 'DISPID_SLRemovePronunciation',
    'SPPS_NotOverriden', 'SpPhoneticAlphabetConverter',
    'eLEXTYPE_PRIVATE1', 'SPVOICESTATUS',
    'DISPID_SpeechPhraseElement', 'DISPID_SPPValue', 'IEnumString',
    'SPSEMANTICFORMAT', 'STCLocalServer', 'SPSHT_EMAIL',
    'SPAUDIOSTATUS', 'SAFT32kHz8BitMono', 'SPCT_DICTATION',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPIReplacements',
    'DISPID_SRGDictationLoad', 'DISPID_SVEStreamEnd',
    'SPRST_NUM_STATES', 'SpInProcRecoContext', 'SpeechRuleState',
    'SPPS_Interjection', 'DISPID_SVGetAudioOutputs',
    'ISpResourceManager', 'DISPID_SRAudioInput', 'SPAUDIOBUFFERINFO',
    'SPRST_ACTIVE_ALWAYS', 'ISpStreamFormat', 'SRSActive',
    'SPPS_RESERVED4', 'DISPID_SRGReset', 'SVSFIsXML',
    'SAFTGSM610_22kHzMono', 'DISPID_SPISaveToMemory', 'SVP_7',
    ...
    'DISPIDSPTSI_ActiveLength', 'SPRECOGNIZERSTATUS',
    'SSSPTRelativeToStart', 'DISPID_SpeechObjectTokenCategory',
    'SpeechUserTraining', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SpeechMMSysAudio', 'SpObjectToken', 'eLEXTYPE_PRIVATE2',
    'SVSFVoiceMask', 'DISPID_SRGetFormat', 'DISPID_SBSFormat',
    'DISPID_SVPause', 'SDTProperty', 'SRADefaultToActive',
    'SPEI_SR_PRIVATE', 'SpeechPropertyAdaptationOn',
    'DISPID_SGRSTRule', 'DISPID_SpeechVoiceEvent', 'SPEI_RESERVED5',
    'ISpeechPhraseReplacements', 'ISpeechRecoContext', 'SRERequestUI',
    'SPSEMANTICERRORINFO', 'SAFTADPCM_22kHzMono', 'SLOStatic',
    'DISPID_SOTDataKey', 'SRERecognition',
    'DISPID_SABufferNotifySize', 'SVSFIsNotXML',
    'SAFTGSM610_44kHzMono', 'STCInprocServer', 'SP_VISEME_7',
    'eLEXTYPE_USER', '_SPAUDIOSTATE', 'DISPID_SRSetPropertyString',
    'ISpeechMemoryStream', 'DISPID_SPEPronunciation',
    'ISpSerializeState', 'SPDKL_CurrentConfig', 'SINoSignal',
    'SpFileStream', 'SDTRule', 'UINT_PTR', 'SVEStartInputStream',
    'eLEXTYPE_APP', 'SPXRO_Alternates_SML', 'SPVISEMES',
    'SpeechVoiceSpeakFlags', 'SPAR_Unknown',
    'DISPID_SVSInputWordLength', 'eLEXTYPE_PRIVATE20', 'SpMMAudioOut',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPAsCount',
    'DISPID_SPRuleName', 'SPPS_LMA', 'SPEI_MAX_SR', 'SPCONTEXTSTATE',
    'SpeechPropertyResponseSpeed', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRCEFalseRecognition', 'ISpProperties', 'ISpRecoContext',
    'SpeechTokenValueCLSID', 'SAFTCCITT_uLaw_8kHzStereo', 'SBOPause',
    'DISPID_SpeechPhraseRule', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVAudioOutput', 'SPEI_PHRASE_START', 'SPLO_STATIC',
    'eLEXTYPE_RESERVED9', 'DISPID_SPAStartElementInResult',
    'DISPID_SVSRunningState', 'SGPronounciation', 'DISPID_SLGetWords',
    'DISPID_SPRuleConfidence', 'SP_VISEME_8',
    'DISPID_SVESentenceBoundary', 'SAFT48kHz8BitMono',
    'DISPID_SPCIdToPhone', 'SAFT44kHz16BitStereo', 'SPEI_SR_BOOKMARK',
    'DISPID_SpeechLexiconWord', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SPRText', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SBSRead', 'SpCustomStream', 'SpeechPartOfSpeech',
    'SSFMOpenReadWrite', 'DISPID_SPPParent', 'SP_VISEME_19',
    'SP_VISEME_13', 'SpeechRegistryUserRoot', 'SpeechStreamFileMode',
    'SPBO_NONE', 'SPEI_RESERVED6', 'DISPID_SPARecoResult',
    'SPDATAKEYLOCATION', 'Speech_StreamPos_Asap',
    'DISPID_SpeechLexiconProns', 'DISPID_SRRecognizer', 'SFTInput',
    'SpeechTokenContext', 'SpPhoneConverter',
    'DISPID_SRCEStartStream', 'DISPID_SPEEngineConfidence',
    'SpeechRecoProfileProperties', 'DISPID_SRRTLength',
    'DISPID_SRSetPropertyNumber', 'SPGS_EXCLUSIVE', 'SPCT_SLEEP',
    'SECFEmulateResult', 'SP_VISEME_2', 'DISPID_SVStatus',
    'DISPID_SpeechRecoResult2', 'SPEI_MIN_TTS',
    'SpeechPropertyHighConfidenceThreshold', 'ISpNotifyTranslator',
    'DISPID_SPRuleNumberOfElements', 'SPEI_FALSE_RECOGNITION',
    'SpNotifyTranslator', 'SPSHORTCUTPAIRLIST', 'SVP_19',
    'ISpeechMMSysAudio', 'SREPropertyStringChange',
    'DISPID_SPEDisplayText', 'DISPID_SVSVisemeId',
    'DISPID_SVPriority', 'ISpeechVoice', 'Speech_Default_Weight',
    'ISpeechLexiconWord', 'DISPID_SRIsUISupported',
    'DISPID_SLPs_NewEnum', 'SPLOADOPTIONS', 'SRSInactiveWithPurge',
    'SPEI_END_SR_STREAM', 'SVSFPersistXML', 'DISPID_SOTCGetDataKey',
    ...
    'DISPID_SpeechPhraseReplacements', 'SAFT32kHz8BitStereo',
    'SDTReplacement', 'SPINTERFERENCE_NONE', 'SPEI_PHONEME',
    'DISPID_SpeechRecognizerStatus', 'SVSFNLPSpeakPunc',
    'SAFT16kHz16BitStereo', 'SPRECOCONTEXTSTATUS',
    'ISpeechLexiconPronunciations', 'SSSPTRelativeToEnd',
    'SPFM_CREATE', 'SGRSTTRule', 'ISpeechPhraseInfo', 'ISpLexicon',
    'SP_VISEME_17', 'DISPID_SVEventInterests',
    'DISPID_SGRSTPropertyValue', 'DISPID_SpeechObjectToken',
    'SPEI_RECO_OTHER_CONTEXT', 'SVF_Stressed', 'SP_VISEME_20',
    'DISPID_SOTCDefault', 'SPPS_Noun', 'SpeechAudioFormatGUIDWave',
    'SAFTCCITT_ALaw_11kHzMono', 'SPVPRIORITY', 'SREStreamStart',
    'SPINTERFERENCE_NOISE', 'DISPID_SDKDeleteKey',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SpeechMemoryStream',
    'SSTTTextBuffer', 'SpeechRecoEvents', 'SPPHRASEPROPERTY',
    'SREHypothesis', 'DISPID_SOTCId', 'SPINTERFERENCE', 'SASStop',
    'SECFDefault', 'ISpRecognizer2', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SRGSetWordSequenceData',
    'ISpeechGrammarRuleStateTransitions',
    'SPEI_PROPERTY_STRING_CHANGE', 'SP_VISEME_14', 'DISPID_SAVolume',
    'ISpeechRecoResult2', 'SPSERIALIZEDPHRASE',
    'ISpeechPhraseAlternates', 'DISPID_SpeechPhraseReplacement',
    'SPEI_WORD_BOUNDARY', 'DISPID_SGRSTNextState',
    'DISPID_SVGetProfiles', 'SREPrivate', 'SAFTADPCM_8kHzMono',
    'SpeechGrammarRuleStateTransitionType',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPIRetainedSizeBytes',
    'SPRS_ACTIVE', 'ISpGrammarBuilder', 'SVSFDefault', 'SPEVENTENUM',
    'SPRULESTATE', 'DISPID_SLWWord',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRGetRecognizers', 'SpeechRunState',
    'SAFTNoAssignedFormat', 'SpLexicon', 'DISPID_SVSLastResult',
    'SVSFUnusedFlags', 'IInternetSecurityManager',
    'SpeechTokenKeyAttributes', 'SRESoundStart', 'SGRSTTWord',
    'SVP_0', 'DISPID_SVSpeak', 'SpeechCategoryAudioOut',
    'DISPID_SLWType', 'DISPID_SRGCmdSetRuleIdState',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SABIMinNotification',
    'SAFTCCITT_uLaw_11kHzMono', 'SpeechEmulationCompareFlags',
    'SPWORD', 'SPEI_MAX_TTS', 'DISPID_SABIBufferSize',
    'ISpObjectToken', 'ISpeechGrammarRuleState',
    'SpeechCategoryAppLexicons', 'SPCT_SUB_DICTATION',
    'DISPID_SRCreateRecoContext', 'SPEI_SOUND_END',
    'eLEXTYPE_PRIVATE18', 'SPEI_TTS_PRIVATE', 'DISPID_SpeechDataKey',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPRDisplayAttributes',
    'SPCT_COMMAND', 'SDTAudio', 'DISPID_SOTDisplayUI',
    'DISPID_SRGCommit', 'SAFT16kHz8BitStereo', 'SPSNoun',
    ...
    'ISpeechLexiconWords', 'DISPID_SDKGetBinaryValue',
    'DISPID_SVVolume', 'DISPID_SAFType', 'SAFT32kHz16BitMono',
    'DISPID_SASFreeBufferSpace', 'SLTApp',
    'DISPID_SRGIsPronounceable', 'DISPID_SPIGrammarId',
    'SPRECORESULTTIMES', 'SVEViseme', 'SAFT24kHz16BitMono',
    'DISPID_SPEsCount', 'DISPID_SPIAudioSizeBytes',
    'SPINTERFERENCE_NOSIGNAL', 'SRAONone',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPRNumberOfElements',
    'DISPID_SPEActualConfidence', 'SGSDisabled', 'SINoise',
    'SLODynamic', 'DISPID_SRGDictationUnload', 'DISPID_SGRsAdd',
    'SpeechGrammarWordType', 'DISPID_SVEWord', 'DISPID_SASetState',
    'DISPID_SPERequiredConfidence', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SGRsItem', 'SVP_10', 'SPGRAMMARWORDTYPE',
    'ISpeechAudioBufferInfo', 'DISPID_SPPsItem',
    'DISPID_SPEAudioSizeTime', 'eLEXTYPE_PRIVATE13',
    'SAFTCCITT_ALaw_44kHzMono', 'SRESoundEnd',
    'DISPID_SRCERecognitionForOtherContext', 'SAFT16kHz8BitMono',
    'SSTTDictation', 'SPEI_VOICE_CHANGE', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPCPhoneToId', 'SDTPronunciation', 'SVP_18',
    ...
    'SpeechDataKeyLocation', 'SpMMAudioIn', 'SpeechBookmarkOptions',
    'SPSTREAMFORMATTYPE', 'SPSHORTCUTTYPE', 'SRAORetainAudio',
    'SAFT22kHz16BitMono', 'DISPID_SVSCurrentStreamNumber',
    'SPSUnknown', 'SPEI_ADAPTATION', 'SpeechDisplayAttributes',
    'SpAudioFormat', 'DISPID_SRCEventInterests', 'SP_VISEME_16',
    'SpShortcut', 'SPDKL_DefaultLocation', 'SPBO_PAUSE',
    'DISPID_SPPConfidence', 'DISPID_SPRuleId',
    'SAFTNonStandardFormat', 'SPTEXTSELECTIONINFO', 'DISPID_SVRate',
    'ISpeechRecoGrammar', 'SPSLMA', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPRuleChildren', 'SGSExclusive', 'tagSTATSTG',
    'SpeechEngineConfidence', 'SpeechDictationTopicSpelling',
    'DISPID_SpeechCustomStream', 'SpeechVoicePriority',
    'SRSEIsSpeaking', 'SVSFParseMask', 'SVEBookmark', 'SVP_20',
    'SPWORDLIST', 'SAFT32kHz16BitStereo', 'SpeechLexiconType',
    'ISpDataKey', 'SASClosed', 'SVP_4', 'DISPID_SWFEExtraData',
    'DISPID_SDKSetStringValue', 'DISPID_SRCCreateGrammar',
    'SVEAudioLevel', 'SpeechPropertyComplexResponseSpeed',
    'SAFT44kHz16BitMono', 'Speech_Max_Word_Length',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SGRAddState',
    'ISpeechObjectTokens', 'DISPID_SPPFirstElement',
    'SPEI_SENTENCE_BOUNDARY', 'SVPOver',
    'ISpPhoneticAlphabetConverter', 'SVSFParseSsml',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRCPause',
    'ISpeechLexicon', 'DISPID_SMSADeviceId', 'SDTDisplayText',
    'DISPID_SRGRules', 'ISpeechAudioFormat', 'DISPID_SPAs_NewEnum',
    'DISPID_SRGCmdLoadFromFile', 'SWPKnownWordPronounceable', 'SVP_9',
    'DISPID_SRGRecoContext', 'SPSHT_Unknown',
    '_ISpeechRecoContextEvents', 'DISPID_SAStatus',
    'DISPID_SRSCurrentStreamPosition', 'SpeechCategoryRecoProfiles',
    'DISPID_SRProfile', 'DISPID_SPIRule', 'SAFTGSM610_8kHzMono',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPRuleParent',
    'ISpPhoneticAlphabetSelection', 'SP_VISEME_11',
    'DISPID_SRCEAudioLevel', 'SVP_16', 'eLEXTYPE_PRIVATE3',
    'ISpeechPhraseElement', 'DISPID_SGRSTransitions',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPRules_NewEnum',
    'DISPID_SDKSetLongValue', 'ISpeechPhraseRules', 'SPPS_Function',
    'DISPID_SpeechGrammarRuleState', 'eLEXTYPE_RESERVED10',
    'DISPID_SPELexicalForm', 'SAFT16kHz16BitMono',
    'SpeechCategoryAudioIn', 'eLEXTYPE_RESERVED6',
    'DISPID_SGRAddResource', 'DISPID_SRSNumberOfActiveRules',
    'SpeechAllElements', 'STCAll', 'SPCS_ENABLED',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SLPsItem',
    'DISPID_SOTGetDescription', 'IStream', 'SP_VISEME_3',
    'SP_VISEME_18', 'SPVPRI_ALERT', 'SVEAllEvents', 'DISPID_SLWsItem',
    'ISpeechGrammarRuleStateTransition', 'SP_VISEME_21',
    'SREStateChange', 'DISPID_SpeechLexiconWords',
    'ISpeechRecoResultTimes', 'SAFT48kHz16BitStereo',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPEAudioSizeBytes',
    'SAFT12kHz16BitStereo', 'SP_VISEME_9', 'DISPID_SpeechVoiceStatus',
    'SPEVENT', 'DISPID_SOTSetId', 'SPEVENTSOURCEINFO',
    'SpeechTokenKeyFiles', 'SSTTWildcard', 'DISPID_SpeechBaseStream',
    'SpeechAudioProperties', 'DISPID_SpeechGrammarRules',
    'DISPID_SOTRemove', 'SPSHT_NotOverriden', 'SECFIgnoreCase',
    'SpeechGrammarState', 'ISpeechPhraseProperty', 'SP_VISEME_5',
    'DISPID_SPPs_NewEnum', 'DISPID_SOTMatchesAttributes',
    'SPRECOSTATE', 'DISPID_SGRClear', 'SVSFParseSapi', 'SPGS_ENABLED',
    'SpeechLoadOption', 'DISPID_SVSPhonemeId', 'SPEI_SR_AUDIO_LEVEL',
    'SPPHRASERULE', 'SPAR_Low', 'DISPID_SMSGetData',
    'SPBO_TIME_UNITS', 'ISequentialStream', 'DISPID_SVAlertBoundary',
    'SGDisplay', 'SECHighConfidence', 'SAFTCCITT_ALaw_22kHzStereo',
    ...
    'DISPID_SOTIsUISupported', 'SDKLCurrentUser',
    'DISPID_SGRsDynamic', 'ISpeechRecognizer', 'SVP_12',
    'SpMMAudioEnum', 'SAFTExtendedAudioFormat', 'SRADynamic',
    'ISpeechPhraseProperties', 'SWTAdded', 'DISPID_SVSkip',
    'DISPID_SLWs_NewEnum', 'DISPID_SPIElements', 'DISPID_SLPsCount',
    'SREFalseRecognition', 'SPEI_RESERVED1', 'DISPID_SGRSTType',
    'SGDSInactive', 'SSFMCreate', 'SpeechAudioState',
    'ISpeechDataKey', 'SPWORDTYPE', 'DISPID_SPEs_NewEnum',
    'DISPIDSPTSI_ActiveOffset', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPGS_DISABLED', 'ISpObjectTokenCategory',
    'DISPID_SLGenerationId', 'SVP_3', 'DISPID_SRCERecognition',
    'DISPID_SGRInitialState', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPEI_RESERVED2', 'SpeechSpecialTransitionType',
    'DISPID_SPEAudioTimeOffset', 'ISpMMSysAudio',
    'DISPID_SVSInputWordPosition', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPCLangId', 'DISPID_SGRId', 'SVSFIsFilename',
    'ISpeechPhraseRule', 'ISpeechObjectTokenCategory',
    'DISPID_SVGetVoices', 'DISPID_SGRs_NewEnum', '_RemotableHandle',
    'eLEXTYPE_PRIVATE11', 'STSF_LocalAppData', 'SPSVerb',
    'SVEPhoneme', 'SPPHRASE', 'SAFTCCITT_ALaw_8kHzStereo', 'SpVoice',
    'SWTDeleted', 'DISPID_SCSBaseStream', 'SpStream', 'SPEI_VISEME',
    'DISPID_SASState', 'DISPID_SpeechVoice',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVSInputSentenceLength',
    'ISpeechGrammarRule', 'SPPROPERTYINFO', 'SAFT11kHz16BitMono',
    'DISPID_SpeechAudioFormat', 'DISPID_SRRAudioFormat',
    'SVEVoiceChange', 'STCRemoteServer', 'SPAS_STOP',
    'DISPID_SRSCurrentStreamNumber', 'SAFT8kHz16BitStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRCEHypothesis',
    'IInternetSecurityMgrSite', 'SAFT24kHz16BitStereo',
    'ISpeechObjectToken', 'SAFT11kHz16BitStereo', 'DISPID_SGRSTsItem',
    'DISPID_SRState', 'ISpeechGrammarRules',
    'DISPID_SRRTOffsetFromStart', 'SPFM_OPEN_READONLY',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SRAImport',
    'DISPID_SMSAMMHandle', 'SPADAPTATIONRELEVANCE', 'SpeechWordType',
    'SpPhraseInfoBuilder', 'LONG_PTR', 'SpeechCategoryRecognizers',
    'DISPID_SPRsItem', 'DISPID_SRRTStreamTime', 'SPAUDIOSTATE',
    'SpInprocRecognizer', 'SpeechPropertyResourceUsage',
    'DISPID_SBSWrite', 'DISPID_SpeechRecoContext', 'SREAdaptation',
    'SVP_2', 'DISPID_SASCurrentSeekPosition', 'DISPID_SVSpeakStream',
    ...
    'SGSEnabled', 'DISPID_SPPId', 'SpeechTokenIdUserLexicon',
    'DISPID_SRRSaveToMemory', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SGRSRule', 'SPRULE', 'DISPID_SpeechPhoneConverter',
    'DISPID_SVEAudioLevel', 'DISPID_SOTCreateInstance',
    'SPSSuppressWord', 'SPXRO_SML', 'DISPID_SWFEBitsPerSample',
    'ISpeechVoiceStatus', 'SREBookmark', 'DISPID_SRGetPropertyString',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SAFT12kHz8BitMono',
    'DISPID_SLWLangId', 'SpUnCompressedLexicon', 'SGDSActive',
    'DISPID_SPAsItem', 'SAFT22kHz8BitMono', 'DISPID_SPRulesCount',
    'DISPID_SREmulateRecognition', 'DISPID_SGRSAddRuleTransition',
    'SP_VISEME_0', 'STSF_AppData', 'ISpEventSink',
    'DISPID_SRGSetTextSelection', 'SpeechTokenKeyUI', 'SVSFlagsAsync',
    'SPLEXICONTYPE', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SLPType', 'ISpeechAudioStatus',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRCEEndStream',
    'SPCATEGORYTYPE', 'eLEXTYPE_PRIVATE4', 'SPEI_START_INPUT_STREAM',
    'ISpeechCustomStream', 'SpeechTokenShellFolder',
    'SPWAVEFORMATTYPE', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SWFEChannels', 'SREStreamEnd', 'DISPID_SRRTTickCount',
    'eLEXTYPE_PRIVATE14', 'SpResourceManager',
    'DISPID_SPANumberOfElementsInResult', 'SPRST_INACTIVE',
    'SPDKL_CurrentUser', 'SRERecoOtherContext',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPSHT_OTHER',
    'SpeechGrammarTagDictation'
]

_check_version('1.2.0', 1697047394.784804)
